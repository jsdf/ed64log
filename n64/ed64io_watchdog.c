 ...
 * debug info
 */
void ed64StartWatchdogThread(int* valToWatchInit) {
  ...
  lastValToWatch = *valToWatch;
  osSetTimer(&watchdogTimer, OS_NSEC_TO_CYCLES(5000000000UL),
             OS_NSEC_TO_CYCLES(1000000000UL), &watchdogMsgQ, /*OSMesg*/ NULL);
